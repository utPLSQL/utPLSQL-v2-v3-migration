...
CREATE OR REPLACE PACKAGE BODY utassert IS
  ...
  ************************************************************************/
  ...
  BEGIN
    utassert2.this(l_outcome, msg_in, check_this_in, null_ok_in, raise_exc_in, register_in);
  END;
  ...
  (
   ...
   ,raise_exc_in  IN BOOLEAN := FALSE
    ...
    l_outcome ut_outcome.id%TYPE;
  BEGIN
    utassert2.eval(l_outcome, msg_in, using_in, value_name_in, null_ok_in, raise_exc_in);
  END;
  ...
  BEGIN
    ...
    utassert2.eval(l_outcome, msg_in, using_in, value_name, null_ok_in, raise_exc_in);
  END;
  ...
  (
   ...
   ,raise_exc_in    IN BOOLEAN := FALSE
    ...
    l_outcome ut_outcome.id%TYPE;
  BEGIN
    utassert2.eq(l_outcome, msg_in, check_this_in, against_this_in, null_ok_in, raise_exc_in);
  END;
  ...
  (
   ...
   ,raise_exc_in     IN BOOLEAN := FALSE
    ...
    l_outcome ut_outcome.id%TYPE;
  BEGIN
    utassert2.eqtabcount(l_outcome
                        ,msg_in
                        ,check_this_in
                        ,against_this_in
                        ,check_where_in
  ...
  (
   ...
   ,raise_exc_in    IN BOOLEAN := FALSE
    ...
    l_outcome ut_outcome.id%TYPE;
  BEGIN
    utassert2.eqquery(l_outcome, msg_in, check_this_in, against_this_in, raise_exc_in);
  END;
  ...
  (
   ...
   ,raise_exc_in     IN BOOLEAN := FALSE
    ...
    l_outcome ut_outcome.id%TYPE;
  BEGIN
    utassert2.eqqueryvalue(l_outcome
                          ,msg_in
                          ,check_query_in
                          ,against_value_in
                          ,null_ok_in
  ...
  (
   ...
   ,raise_exc_in    IN BOOLEAN := FALSE
    ...
    l_outcome ut_outcome.id%TYPE;
  BEGIN
    utassert2.eqpipe(l_outcome, msg_in, check_this_in, against_this_in, raise_exc_in);
  END;
  ...
  (
   ...
   ,raise_exc_in  IN BOOLEAN := FALSE
    ...
    l_outcome ut_outcome.id%TYPE;
  BEGIN
    utassert2.objexists(l_outcome, msg_in, check_this_in, null_ok_in, raise_exc_in);
  END;
  ...
  (
   ...
   ,raise_exc_in  IN BOOLEAN := FALSE
    ...
    l_outcome ut_outcome.id%TYPE;
  BEGIN
    utassert2.objnotexists(l_outcome, msg_in, check_this_in, null_ok_in, raise_exc_in);
  END;
